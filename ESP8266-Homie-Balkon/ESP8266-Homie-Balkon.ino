...
void loopHandler() {
  ...
  if (millis() - lastTemperatureSent >= TEMPERATURE_INTERVAL * 1000UL || lastTemperatureSent == 0) {
    ...
    temperature = temperature-3.2; // Offset 2
    humidity = humidity; // Offset+6
...
void setup() {
  ...
  debouncermotion.interval(100);
  debouncerlight.interval(60);

  Homie_setFirmware("ESP8266-Homie-Balkon", "1.0.0");

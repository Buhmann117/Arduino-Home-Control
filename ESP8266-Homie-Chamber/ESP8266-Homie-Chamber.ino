...
const int PIN_MOTION =0;
const int PIN_LIGHT = 1; //Tx pin 1
...
void loopHandler() {
  ...
  if (millis() - lastTemperatureSent >= TEMPERATURE_INTERVAL * 1000UL || lastTemperatureSent == 0) {
    ...
    temperature = temperature-3.7; // Hier Offset -x.x
    humidity = humidity+1.5; // Hier Offset -x.x
...
void setup() {
  ...
  debouncermotion.interval(300);
  debouncerlight.interval(10);

  Homie_setFirmware("ESP8266-Homie-Chamber", "1.0.0");
